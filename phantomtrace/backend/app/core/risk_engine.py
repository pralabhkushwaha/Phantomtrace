...
def compute_risk_score(
    ...
    # ---- Content ----
    content_pts = min(int(content_score * 0.25), 25)
    ...
    # ---- URL ----
    url_pts = min(int(url_score * 0.30), 30)
